...
The model should be able to create accurate and readable (i.e a sentence that represents the image provided). The caption should be roughl 35 characters long (subject to change). 
